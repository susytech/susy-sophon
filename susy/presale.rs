...
pub fn import_account(cmd: &ImportWallet, kp: sofkey::KeyPair, password: Password) {
	...
	let secret_store = Box::new(SofStore::open_with_iterations(dir, cmd.iterations).unwrap());
...
pub fn import_account(_cmd: &ImportWallet, _kp: sofkey::KeyPair, _password: Password) {}
