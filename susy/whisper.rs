...
use susy_rpc::Metadata;
use susy_whisper::message::Message;
use susy_whisper::net::{self as whisper_net, Network as WhisperNetwork};
use susy_whisper::rpc::{WhisperClient, PoolHandle, FilterManager};
	...
	-> io::Result<Option<RpcFactory>>
{
	...
	// susy-only extensions to whisper.
	protos.push(AttachedProtocol {
		handler: Arc::new(whisper_net::SusyExtensions),
		versions: whisper_net::SUPPORTED_VERSIONS,
		protocol_id: whisper_net::SUSY_PROTOCOL_ID,
	});
