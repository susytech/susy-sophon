...
pub struct HardcodedSync {
	/// Hexadecimal of the SRLP encoding of the header of the block to start synchronization from.
	pub header: String,
...
mod tests {
	use serde_json;
	use uint::Uint;
	use sophon_types::{U256, H256 as Sof256};
	use hash::H256;
	...
	fn hardcoded_sync_deserialization() {
		...
		assert_eq!(deserialized, HardcodedSync {
			...
			chts: vec![
				H256(Sof256::from("0x11bbe8db4e347b4e8c937c1c8370e4b5ed33adb3db69cbdb7a38e1e50b1b82fa")),
				H256(Sof256::from("0xd7f8974fb5ac78d9ac099b9ad5018bedc2ce0a72dad1827a1709da30580f0544")),
			]
		});
	}
}
