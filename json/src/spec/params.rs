...
pub struct Params {
	...
	/// Name of the main ("sof") subprotocol.
	...
	/// See main SofashParams docs.
	pub sip150_transition: Option<Uint>,

	/// See main SofashParams docs.
	pub sip160_transition: Option<Uint>,

	/// See main SofashParams docs.
	pub sip161abc_transition: Option<Uint>,
	/// See main SofashParams docs.
	pub sip161d_transition: Option<Uint>,

	/// See `CommonParams` docs.
	pub sip98_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip155_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub validate_chain_id_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub validate_receipts_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip140_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip210_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip210_contract_address: Option<Address>,
	/// See `CommonParams` docs.
	pub sip210_contract_code: Option<Bytes>,
	/// See `CommonParams` docs.
	pub sip210_contract_gas: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip211_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip145_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip214_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip658_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip1052_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip1283_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip1283_disable_transition: Option<Uint>,
	/// See `CommonParams` docs.
	pub sip1014_transition: Option<Uint>,
	/// See `CommonParams` docs.
	...
	/// Maximum size of transaction SRLP payload.
