...
use rustc_hex::ToHex;
use sophon_types::{H64 as Hash64, H160 as Hash160, H256 as Hash256, H520 as Hash520, Bloom as Hash2048};
...
mod test {
	...
	fn hash_deserialization() {
		...
		assert_eq!(deserialized, vec![
				   H256(sophon_types::H256::from(0)),
				   H256(sophon_types::H256::from_str("5a39ed1020c04d4d84539975b893a4e7c53eab6c2965db8bc3468093a31bc5ae").unwrap())
		]);
	}

	#[test]
	fn hash_into() {
		assert_eq!(sophon_types::H256::from(0), H256(sophon_types::H256::from(0)).into());
	}
}
