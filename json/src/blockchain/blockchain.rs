...
use spec::{ForkSpec, Genesis, Seal, Sophon};
...
pub struct BlockChain {
	...
	/// Genesis block srlp.
	#[serde(rename = "genesisSRLP")]
	pub genesis_srlp: Option<Bytes>,
	/// Blocks.
...
impl BlockChain {
	/// Returns blocks srlp.
	pub fn blocks_srlp(&self) -> Vec<Vec<u8>> {
		self.blocks.iter().map(|block| block.srlp()).collect()
	}

	/// Returns spec compatible genesis struct.
	pub fn genesis(&self) -> Genesis {
		Genesis {
			seal: Seal::Sophon(Sophon {
	...
	fn blockchain_deserialization() {
		let s = r#"{
			"blocks" : [{
				...
				"srlp" : "",
				"transactions" : [
					{
						"data" : "0x00",
						"gasLimit" : "0xc350",
			...
			"genesisSRLP" : "",
