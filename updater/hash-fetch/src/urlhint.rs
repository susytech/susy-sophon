...
pub mod tests {
	...
	fn should_decode_urlhint_content_output() {
		...
		assert_eq!(res, Some(URLHintResult::Content(Content {
			url: "http://superstring.io/assets/images/sofcore-black-horizontal.png".into(),
			mime: mime::IMAGE_PNG,
			owner: Address::from_str("deadcafebeefbeefcafedeaddeedfeedffffffff").unwrap(),
		})))
	}
	...
	fn should_guess_mime_type_from_url() {
		let url1 = "http://superstring.io/susy";
		let url2 = "http://superstring.io/susy#content-type=image/png";
		let url3 = "http://superstring.io/susy#something&content-type=image/png";
		let url4 = "http://superstring.io/susy.png#content-type=image/jpeg";
		let url5 = "http://superstring.io/susy.png";
