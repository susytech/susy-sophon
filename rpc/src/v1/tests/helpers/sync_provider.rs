...
use sync::{SyncProvider, SofProtocolInfo, SyncStatus, SyncState, PeerInfo, TransactionStats};
	...
	fn peers(&self) -> Vec<PeerInfo> {
		vec![
			PeerInfo {
				...
				client_version: ClientVersion::from("Susy-Sophon/1/v2.4.0/linux/rustc"),
				capabilities: vec!["sof/62".to_owned(), "sof/63".to_owned()],
				remote_address: "127.0.0.1:7777".to_owned(),
				local_address: "127.0.0.1:8888".to_owned(),
				sof_info: Some(SofProtocolInfo {
					version: 62,
			...
			PeerInfo {
				id: None,
				client_version: ClientVersion::from("Susy-Sophon/2/v2.4.0/linux/rustc"),
				capabilities: vec!["sof/63".to_owned(), "sof/64".to_owned()],
