...
impl SusyAccountsInfo for SusyAccountsClient {
	fn accounts_info(&self) -> Result<BTreeMap<H160, AccountInfo>> {
		self.deprecation_notice("susy_accountsInfo");
	...
	fn hardware_accounts_info(&self) -> Result<BTreeMap<H160, HwAccountInfo>> {
		self.deprecation_notice("susy_hardwareAccountsInfo");
	...
	fn locked_hardware_accounts_info(&self) -> Result<Vec<String>> {
		self.deprecation_notice("susy_lockedHardwareAccountsInfo");
	...
	fn default_account(&self) -> Result<H160> {
		self.deprecation_notice("susy_defaultAccount");
...
impl SusyAccounts for SusyAccountsClient {
	...
	fn new_account_from_phrase(&self, phrase: String, pass: Password) -> Result<H160> {
		self.deprecation_notice("susy_newAccountFromPhrase");
	...
	fn new_account_from_wallet(&self, json: String, pass: Password) -> Result<H160> {
		self.deprecation_notice("susy_newAccountFromWallet");
	...
	fn new_account_from_secret(&self, secret: H256, pass: Password) -> Result<H160> {
		self.deprecation_notice("susy_newAccountFromSecret");
	...
	fn test_password(&self, account: H160, password: Password) -> Result<bool> {
		self.deprecation_notice("susy_testPassword");
	...
	fn change_password(&self, account: H160, password: Password, new_password: Password) -> Result<bool> {
		self.deprecation_notice("susy_changePassword");
		let account: Address = account.into();
		self.accounts
	...
	fn kill_account(&self, account: H160, password: Password) -> Result<bool> {
		self.deprecation_notice("susy_killAccount");
		let account: Address = account.into();
		self.accounts
	...
	fn remove_address(&self, addr: H160) -> Result<bool> {
		self.deprecation_notice("susy_removeAddresss");
	...
	fn set_account_name(&self, addr: H160, name: String) -> Result<bool> {
		self.deprecation_notice("susy_setAccountName");
		let addr: Address = addr.into();
	...
	fn set_account_meta(&self, addr: H160, meta: String) -> Result<bool> {
		self.deprecation_notice("susy_setAccountMeta");
		let addr: Address = addr.into();
	...
	fn import_graviton_accounts(&self, addresses: Vec<H160>) -> Result<Vec<H160>> {
		self.deprecation_notice("susy_importGravitonAccounts");
		self.accounts
			.import_graviton_accounts(into_vec(addresses), false)
			.map(into_vec)
			.map_err(|e| errors::account("Couldn't import Graviton accounts", e))
	}

	fn graviton_accounts(&self) -> Result<Vec<H160>> {
		self.deprecation_notice("susy_listGravitonAccounts");
		Ok(into_vec(self.accounts.list_graviton_accounts(false)))
	}

	fn create_vault(&self, name: String, password: Password) -> Result<bool> {
		self.deprecation_notice("susy_newVault");
	...
	fn open_vault(&self, name: String, password: Password) -> Result<bool> {
		self.deprecation_notice("susy_openVault");
	...
	fn close_vault(&self, name: String) -> Result<bool> {
		self.deprecation_notice("susy_closeVault");
	...
	fn list_vaults(&self) -> Result<Vec<String>> {
		self.deprecation_notice("susy_listVaults");
	...
	fn list_opened_vaults(&self) -> Result<Vec<String>> {
		self.deprecation_notice("susy_listOpenedVaults");
	...
	fn change_vault_password(&self, name: String, new_password: Password) -> Result<bool> {
		self.deprecation_notice("susy_changeVaultPassword");
	...
	fn change_vault(&self, address: H160, new_vault: String) -> Result<bool> {
		self.deprecation_notice("susy_changeVault");
		self.accounts
	...
	fn get_vault_meta(&self, name: String) -> Result<String> {
		self.deprecation_notice("susy_getVaultMeta");
	...
	fn set_vault_meta(&self, name: String, meta: String) -> Result<bool> {
		self.deprecation_notice("susy_setVaultMeta");
	...
	fn derive_key_index(&self, addr: H160, password: Password, derivation: DeriveHierarchical, save_as_account: bool) -> Result<H160> {
		self.deprecation_notice("susy_deriveAddressIndex");
		let addr: Address = addr.into();
		self.accounts
			.derive_account(
				&addr,
	...
	fn derive_key_hash(&self, addr: H160, password: Password, derivation: DeriveHash, save_as_account: bool) -> Result<H160> {
		self.deprecation_notice("susy_deriveAddressHash");
		let addr: Address = addr.into();
		self.accounts
			.derive_account(
				&addr,
	...
	fn export_account(&self, addr: H160, password: Password) -> Result<KeyFile> {
		self.deprecation_notice("susy_exportAccount");
		let addr = addr.into();
		self.accounts
			.export_account(
				&addr,
	...
	fn sign_message(&self, addr: H160, password: Password, message: H256) -> Result<H520> {
		self.deprecation_notice("susy_signMessage");
		self.accounts
			.sign(
				addr.into(),
				Some(password),
	...
	fn hardware_pin_matrix_ack(&self, path: String, pin: String) -> Result<bool> {
		self.deprecation_notice("susy_hardwarePinMatrixAck");
