...
//! SIP-191 specific types

use sophon_types::H160;
use serde::{Deserialize, Deserializer};
use serde::de;
use v1::types::Bytes;

/// SIP-191 version specifier
#[derive(Debug)]
pub enum SIP191Version {
...
impl<'de> Deserialize<'de> for SIP191Version {
			...
			D: Deserializer<'de>,
	{
		...
		let byte_version = match s.as_str() {
			"0x00" => SIP191Version::PresignedTransaction,
			"0x01" => SIP191Version::StructuredData,
			"0x45" => SIP191Version::PersonalMessage,
