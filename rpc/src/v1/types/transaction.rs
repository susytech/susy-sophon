...
use sofcore::{contract_address, CreateContractAddress};
use sophon_types::{H160, H256, H512, U64, U256};
use miner;
...
/// Graviton-compatible output for sof_signTransaction method
#[derive(Debug, Default, Clone, PartialEq, Serialize)]
pub struct RichRawTransaction {
	/// Raw transaction SRLP
	pub raw: Bytes,
	/// Transaction details
	#[serde(rename = "tx")]
