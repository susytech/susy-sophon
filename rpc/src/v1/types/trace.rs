...
use sofcore::client::Executed;
use sofcore::trace as et;
use sofcore::trace::{FlatTrace, LocalizedTrace as SofLocalizedTrace, trace, TraceError};
...
impl From<SofLocalizedTrace> for LocalizedTrace {
	fn from(t: SofLocalizedTrace) -> Self {
		LocalizedTrace {
