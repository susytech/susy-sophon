...
pub struct PeerProtocolsInfo {
	/// Sophon protocol information
	pub sof: Option<SofProtocolInfo>,
	/// PIP protocol information.
	pub pip: Option<PipProtocolInfo>,
}

/// Peer Sophon protocol information
#[derive(Default, Debug, Serialize)]
pub struct SofProtocolInfo {
	/// Negotiated sophon protocol version
	pub version: u32,
...
impl From<sync::SofProtocolInfo> for SofProtocolInfo {
	fn from(info: sync::SofProtocolInfo) -> Self {
		SofProtocolInfo {
