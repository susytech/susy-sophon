...
use sophon_types::{H160, H256, U64, U256, Bloom as H2048};
use v1::types::Log;
use types::receipt::{Receipt as SofReceipt, RichReceipt, LocalizedReceipt, TransactionOutcome};
...
impl From<SofReceipt> for Receipt {
	fn from(r: SofReceipt) -> Self {
		Receipt {
			from: None,
			to: None,
