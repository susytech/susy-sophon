...
use sofcore::client::{BlockChainClient, ProvingBlockChainClient, ChainInfo, BlockInfo as ClientBlockInfo};
...
#[cfg(test)]
mod tests {
	use sofcore::client::{EachBlockWith, TestBlockChainClient};
	use super::Provider;
