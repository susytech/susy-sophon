...
//! Cost schedule and other parameterisations for the SVM.

/// Definition of the cost schedule and other parameterisations for the SVM.
pub struct Schedule {
...
impl Schedule {
	/// Schedule for the Frontier-era of the Sophon main net.
	pub fn new_frontier() -> Schedule {
		Self::new(false, false, 21000)
	}

	/// Schedule for the Homestead-era of the Sophon main net.
	pub fn new_homestead() -> Schedule {
		Self::new(true, true, 53000)
	}

	/// Schedule for the post-SIP-150-era of the Sophon main net.
	pub fn new_post_sip150(max_code_size: usize, fix_exp: bool, no_empty: bool, kill_empty: bool) -> Schedule {
		Schedule {
	...
	/// Schedule for the Byzantium fork of the Sophon main net.
	pub fn new_byzantium() -> Schedule {
		let mut schedule = Self::new_post_sip150(24576, true, true, true);
	...
	/// Schedule for the Constantinople fork of the Sophon main net.
