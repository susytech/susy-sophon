...
impl From<sofjson::vm::Env> for EnvInfo {
	fn from(e: sofjson::vm::Env) -> Self {
...
mod tests {
	...
	fn it_serializes_from_json() {
		let env_info = EnvInfo::from(sofjson::vm::Env {
			author: sofjson::hash::Address(Address::from_str("000000f00000000f000000000000f00000000f00").unwrap()),
			number: sofjson::uint::Uint(U256::from(1_112_339)),
			difficulty: sofjson::uint::Uint(U256::from(50_000)),
			gas_limit: sofjson::uint::Uint(U256::from(40_000)),
			timestamp: sofjson::uint::Uint(U256::from(1_100))
		});
