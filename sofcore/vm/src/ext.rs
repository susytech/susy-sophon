...
//! Interface for Svm externalities.
...
pub enum CreateContractAddress {
	...
	FromSenderAndNonce,
	/// Address is calculated from sender, salt and code hash. pWASM `create2` scheme and SIP-1014 CREATE2 scheme.
	FromSenderSaltAndCodeHash(H256),
	/// Address is calculated from code hash and sender. Used by swasm create ext.
	FromSenderAndCodeHash,
}

/// Externalities interface for SVMs
pub trait Ext {
