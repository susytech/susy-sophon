...
use swasmi::{self, MemoryRef, RuntimeArgs, RuntimeValue, Error as InterpreterError, Trap, TrapKind};
...
impl swasmi::HostError for Error { }
...
impl<'a> Runtime<'a> {
	...
	/// Loads 160-bit hash (Sophon address) from the specified sandboxed memory pointer
...
mod ext_impl {
	...
	use swasmi::{Externals, RuntimeArgs, RuntimeValue, Trap};
	use env::ids::*;
