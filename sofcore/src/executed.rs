...
use sophon_types::{U256, U512, Address};
use bytes::Bytes;
use softrie;
use vm;
...
pub enum ExecutionError {
	...
	SenderMustExist,
	/// Returned when internal svm error occurs.
	Internal(String),
	/// Returned when generic transaction occurs
	TransactionMalformed(String),
}

impl From<Box<softrie::TrieError>> for ExecutionError {
	fn from(err: Box<softrie::TrieError>) -> Self {
		ExecutionError::Internal(format!("{:?}", err))
	}
}
impl From<softrie::TrieError> for ExecutionError {
