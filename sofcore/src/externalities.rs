...
/// Implementation of svm Externalities.
	...
	where T: Tracer, V: VMTracer, B: StateBackend
{
	...
	fn blockhash(&mut self, number: &U256) -> H256 {
		if self.env_info.number + 256 >= self.machine.params().sip210_transition {
			let blockhash_contract_address = self.machine.params().sip210_contract_address;
			...
			let params = ActionParams {
				...
				gas: self.machine.params().sip210_contract_gas,
				gas_price: 0.into(),
				code: code,
				code_hash: code_hash,
