...
use engines::{SofEngine, EpochVerifier};
...
impl AncientVerifier {
	...
	fn initial_verifier(&self, header: &Header, chain: &BlockChain)
		-> Result<Box<EpochVerifier<SophonMachine>>, ::error::Error>
	{
