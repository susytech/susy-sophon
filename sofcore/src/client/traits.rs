...
pub trait ImportBlock {
	...
	fn import_block(&self, block: Unverified) -> SofcoreResult<H256>;
}
...
pub trait IoClient: Sync + Send {
	...
	fn queue_ancient_block(&self, block_bytes: Unverified, receipts_bytes: Bytes) -> SofcoreResult<H256>;
...
+ IoClient + BadBlocks {
	...
	/// Block body is an SRLP list of two items: uncles and transactions.
