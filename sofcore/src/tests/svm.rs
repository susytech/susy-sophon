...
//! Tests of SVM integration with transaction execution.
...
svm_test!{test_blockhash_sip210: test_blockhash_sip210_int}
fn test_blockhash_sip210(factory: Factory) {
	...
	let machine = ::sophon::new_sip210_test_machine();
