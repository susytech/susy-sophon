...
use sofcore_miner::gas_pricer::GasPricer;
use sofcore_miner::local_accounts::LocalAccounts;
use sofcore_miner::pool::{self, TransactionQueue, VerifiedTransaction, QueueStatus, PrioritizationStrategy};
#[cfg(feature = "work-notify")]
use sofcore_miner::work_notify::NotifyWork;
...
use engines::{SofEngine, Seal, EngineSigner};
...
mod tests {
	...
	fn dynamic_gas_pricer() -> GasPricer {
		...
		use sofcore_miner::gas_price_calibrator::{GasPriceCalibrator, GasPriceCalibratorOptions};
