...
use susy_machine::{Machine, Header, LiveBlock, TotalScoredHeader};
...
impl From<::sofjson::spec::NullEngineParams> for NullEngineParams {
	fn from(p: ::sofjson::spec::NullEngineParams) -> Self {
		NullEngineParams {
