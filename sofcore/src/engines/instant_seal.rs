...
use susy_machine::{Machine, Transactions, TotalScoredHeader};
...
impl From<::sofjson::spec::InstantSealParams> for InstantSealParams {
	fn from(p: ::sofjson::spec::InstantSealParams) -> Self {
		InstantSealParams {
