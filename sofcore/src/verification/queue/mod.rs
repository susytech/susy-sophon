...
impl<K: Kind> VerificationQueue<K> {
	...
	pub fn new(config: Config, engine: Arc<SofEngine>, message_channel: IoChannel<ClientIoMessage>, check_seal: bool) -> Self {
...
mod tests {
	...
	fn new_unverified(bytes: Bytes) -> Unverified {
		Unverified::from_srlp(bytes).expect("Should be valid srlp")
	}
