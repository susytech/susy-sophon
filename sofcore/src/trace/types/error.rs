...
use std::fmt;
use srlp::{Encodable, RlpStream, Decodable, DecoderError, Rlp};
...
pub enum Error {
	...
	BuiltIn,
	/// Returned on svm internal error. Should never be ignored during development.
