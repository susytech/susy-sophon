...
impl ManifestData {
	/// Encode the manifest data to srlp.
	pub fn into_srlp(self) -> Bytes {
	...
	/// Try to restore manifest data from raw bytes, interpreted as SRLP.
	pub fn from_srlp(raw: &[u8]) -> Result<Self, DecoderError> {
