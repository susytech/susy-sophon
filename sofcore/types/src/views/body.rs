...
impl<'a> BodyView<'a> {
	/// Creates new view onto block body from srlp.
	...
	/// }
	/// ```
	pub fn new(srlp: ViewRlp<'a>) -> BodyView<'a> {
		BodyView {
			srlp: srlp
		}
	}
	...
	pub fn transactions_count(&self) -> usize {
		self.transactions_srlp().item_count()
	}
	/// Return List of transactions in given block.
