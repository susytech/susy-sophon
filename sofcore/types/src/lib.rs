...
//!
//! This crate stores Susy Sophyem specific types that are
...
//! Don't treat this crate as a bag for any types that we use in Susy Sophon.
//! This one is reserved for types that are shared heavily (like transactions),
//! historically this contains types extracted from `sofcore` crate, if possible
