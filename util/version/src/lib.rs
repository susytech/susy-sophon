...
//! Susy version specific information.
...
pub fn version() -> String {
	...
	format!("Susy-Sophon/v{}-{}{}{}{}{}/{}/rustc{}", env!("CARGO_PKG_VERSION"), THIS_TRACK, sha3_dash, sha3, date_dash, commit_date, platform(), generated::rustc_version())
}
