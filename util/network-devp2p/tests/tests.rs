...
extern crate sofcore_network;
extern crate sofcore_network_devp2p;
extern crate sofkey;
...
use sofcore_network::*;
use sofcore_network_devp2p::NetworkService;
...
impl NetworkProtocolHandler for TestProtocol {
	...
	fn connected(&self, io: &NetworkContext, peer: &PeerId) {
		assert!(io.peer_client_version(*peer).to_string().contains("Susy"));
