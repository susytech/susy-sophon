...
//! Façade crate for `susy_patricia_trie` for Sophon specific impls

pub extern crate trie_db as trie; // `pub` because we need to import this crate for the tests in `susy_patricia_trie` and there were issues: https://gist.github.com/dvdplm/869251ee557a1b4bd53adc7c971979aa
...
pub use srlp_node_codec::RlpNodeCodec;
...
/// use softrie::{TrieDBMut, trie::TrieMut};
/// use keccak_hasher::KeccakHasher;
/// use memory_db::*;
/// use sophon_types::H256;
/// use elastic_array::ElasticArray128;
