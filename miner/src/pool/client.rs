...
//! It includes any Sophon state parts required for checking the transaction and
//! any consensus-required structure of the transaction.

use std::fmt;

use sophon_types::{U256, H256, H160 as Address};
...
pub trait Client: fmt::Debug + Sync {
	...
	/// Performs pre-validation of SRLP decoded transaction
