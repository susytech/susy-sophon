...
use keccak::H256;
use shared::{SOFASH_ACCESSES, SOFASH_MIX_BYTES, Node, get_data_size};
...
const PROGPOW_CNT_DAG: usize = SOFASH_ACCESSES;
const PROGPOW_DAG_LOADS: usize = 4;
const PROGPOW_MIX_BYTES: usize = 2 * SOFASH_MIX_BYTES;
