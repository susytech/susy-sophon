...
pub const SOFASH_EPOCH_LENGTH: u64 = 30000;
pub const SOFASH_CACHE_ROUNDS: usize = 3;
pub const SOFASH_MIX_BYTES: usize = 128;
pub const SOFASH_ACCESSES: usize = 64;
pub const SOFASH_DATASET_PARENTS: u32 = 256;
...
pub fn epoch(block_number: u64) -> u64 {
	block_number / SOFASH_EPOCH_LENGTH
}
...
pub fn get_cache_size(block_number: u64) -> usize {
	// TODO: Memoise
	let mut sz: u64 = CACHE_BYTES_INIT + CACHE_BYTES_GROWTH * (block_number / SOFASH_EPOCH_LENGTH);
...
pub fn get_data_size(block_number: u64) -> usize {
	// TODO: Memoise
	let mut sz: u64 = DATASET_BYTES_INIT + DATASET_BYTES_GROWTH * (block_number / SOFASH_EPOCH_LENGTH);
	sz = sz - SOFASH_MIX_BYTES as u64;
	while !is_prime(sz / SOFASH_MIX_BYTES as u64) {
		sz = sz - 2 * SOFASH_MIX_BYTES as u64;
	}
	sz as usize
}
