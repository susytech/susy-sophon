...
pub trait Wallet<'a> {
	...
	/// Generate sophon address for a Wallet
	...
	///		* <https://octonion.institute/susytech/hidapi-rs>
...
/// or less a duplicate of `sofcore::transaction::Transaction`, but we can't
/// import sofcore here as that would be a circular dependency.
...
impl HardwareWalletManager {
	...
	/// It is managed by `sofcore/account_provider`
