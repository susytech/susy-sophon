...
package io.susy.sophon;

/**
 * Interface to the Susy client.
 */
public class Susy {
	/**
	 * Starts the Susy client with the CLI options passed as an array of strings.
	 *
	 * Each space-delimited option corresponds to an array entry.
	 * For example: `["--port", "12345"]`
	 *
	 * @param options The CLI options to start Susy with
	 */
	public Susy(String[] options, String loggerMode, String loggerFile) {
	...
	// FIXME: `finalize` is deprecated - https://octonion.institute/susytech/susy-sophon/issues/10066
	@Override
